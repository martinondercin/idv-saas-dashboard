...
const failedTransactions = [
  {
    ...
    userId: "usr_12345",
    type: "OCR", 
    failureReason: "Invalid Data - document data extraction failed",
  ...
  },
  {
    ...
    failureReason: "No Face Detected in captured image",
  ...
  },
  {
    ...
    failureReason: "Not Enough Data available for verification",
  ...
  },
  {
    ...
    failureReason: "Page does not match document type previous page",
  ...
  },
  {
    ...
    userId: "usr_97531",
    type: "OCR", 
    failureReason: "No document corner detected in image",
    errorCode: "NO_CORNER_DETECTED",
  ...
  },
  {
    ...
    userId: "usr_86420",
    type: "Document Verification", 
    failureReason: "Document type not recognized by system",
    errorCode: "DOC_TYPE_NOT_RECOGNIZED",
    timestamp: "2024-01-22 09:30:55",
    country: "AU",
    riskScore: 72,
    retryAttempts: 1,
    canRetry: true
